...
<div class="container-fluid text-center">
	<div class="row content">
		...
		<!-- 2순위 게시판 -->
		<div class="col-sm-8 text-left">
		<c:forEach var="obj" items="${tagResult}">
				<c:forEach items="${boardida }" var="board">
			<c:choose>
					<c:when test="${board eq obj._id}">
							같은것들
					</c:when>
		...
		<!-- 3순위 게시판  -->
		<div class="col-sm-8 text-left">
			<c:forEach var="obj" items="${top5Result}">
				<div align="center" style="min-height: 590px;">
					<section style="float: center; width: 70%;">
						<div>
							<c:choose>
		...
		<!-- 4순위 게시판 -->
		<div class="col-sm-8 text-left">
			<c:forEach var="obj" items="${followingResult}">
				<div align="center" style="min-height: 590px;">
					<section style="float: center; width: 70%;">
						<div>
							<c:choose>
		...
		<!-- 5순위 게시판 -->
				<div class="col-sm-8 text-left">
			<c:forEach var="obj" items="${followerResult}">
				<div align="center" style="min-height: 590px;">
					<section style="float: center; width: 70%;">
						<div>
							<c:choose>
