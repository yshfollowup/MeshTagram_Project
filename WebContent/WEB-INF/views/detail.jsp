...
<!--↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓아이디 & 헤더 부분↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓-->
					<header class="_7b8eu _9dpug">
						<div class="_82odm _i2o1o" style="float: left; width: 40px;">
							...
							<div class="_pg23k _jpwof _gvoze" style="width: 30px; height: 30px;">
								<c:choose>
									<c:when test="${empty obj.profile}">
										<img src="/images/insta.jpg" id="writer">
									</c:when>
									<c:otherwise>
										<img src="${applicationScope.path }${obj.profile}" id="writer">
									</c:otherwise>
								</c:choose>
								</div>
							</div>
									...
									<ul class="_b0tqa">
										<li class="_ezgzd"><a class="_2g7d5 notranslate _95hvo"
											...
											<c:forEach items="${obj.comment }" var="comm">
												...
												<span><a
													href="/searchtag.do?tags=${fn:replace(tag,'#','%23') }">${tag }</a></span>
											</c:forEach></li>
									</ul>
								</div>
