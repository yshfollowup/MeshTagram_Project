				...
				<article class="_75z9k">
					...
					<form id="form2" class="_gzffa" action="/mypage/edit.do"
						...
						<div class="_e1xik">
							...
							<div class="_cd2n1">
								<input type="text" class="_4abhr _o716c" aria-required="false"
									id="pepName" value="${aDTO.name }" name="name">
							</div>
						</div>
						...
						<div class="_e1xik">
							...
							<div class="_cd2n1">
								<input type="text" class="_4abhr _o716c" aria-required="false"
									id="pepEmail" value="${aDTO.email }" name="email">
							</div>
						</div>
						<div class="_e1xik">
							<aside class="_kx10g">
							...
							<div class="_cd2n1">
								<div class="_eqmpg">
									<span class="_ov9ai" ><button type="submit" id="bioBt"
										...
										<a class="_61tuv" href="/mypage/deletePage.do" id="delete">계정 삭제</a>
								</div>
							</div>
						</div>
					</form>
