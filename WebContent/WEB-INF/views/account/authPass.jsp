					...
					<div class="_f9sjj">
						...
						<div class="_1zdb1">
								<div class="_t296e">
									<div class="_sjplo">
										<div class="_ev9xl">
											<input type="text" class="_ph6vk _jdqpn _o716c" id="cppEmail"
												name="email" placeholder="새 비밀번호를 받을 이메일 주소를 입력하세요" pattern="[A-Za-z0-9]+" aria-required="true" value="" required>
										</div>
										<div class="_gaby6"></div>
									</div>
								</div>
								<span class="_t38eb _ov9ai"><button id="authBt" type="button"
										class="_qv64e _gexxb _4tgw8 _njrw0 btn btn-default">비밀번호 재설정</button></span>
						</div>
					</div>
					<div class="_f9sjj" id="change">
						<p class="_g9ean" style="color:rgb(0,0,0); font-weight:bold;">
							계정이 없으신가요?&nbsp;&nbsp;&nbsp;
							<button id="ch1" class="_qv64e _gexxb _4tgw8 _njrw0 btn btn-default" style="width:80px;">가입하기</button>
							<button type="button" id="ch2"
