...
<form action="/account/join.do"  autocomplete="off">
	<p>
		...
		style="padding: 5px; font-size: 14pt; width: 250px;" pattern="[A-Za-z0-9]+"/>영문 숫자 최소 5자리
	</p>
	<p>
	...
	<p>
		<input type="text" id="email" name="email" placeholder="이메일"
			value="${email }" style="padding: 5px; font-size: 14pt; width: 250px;"/>
		<button type="button" id="confirm">인증</button>
		<span id="rst"></span>

	</p>
	<p>
		<input type="text" id="pass1" name="pass1" placeholder="비밀번호" pattern="[A-Za-z0-9]+"
		style="padding: 5px; font-size: 14pt; width: 250px;"/>
	</p>
	<p>
		<input type="text" id="pass2" name="pass2" placeholder="비밀번호 확인" pattern="[A-Za-z0-9]+"
